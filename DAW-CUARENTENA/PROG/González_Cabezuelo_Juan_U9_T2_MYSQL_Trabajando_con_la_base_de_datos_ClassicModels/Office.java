...
public class Office{
    ...
    public String toString() {
        return "OFICINA{CODE: "+officeCode+" | CIUDAD: "+city+" | TFN: "+phone+" | DIRCN1: "+addressLine1+" | DIRCN2: "+addressLine2+" | ESTADO: "+state+" | PAIS: "+country+" | CP: "+postalCode+" | TERRITORIO: "+territory+"}\n";
    }
}
