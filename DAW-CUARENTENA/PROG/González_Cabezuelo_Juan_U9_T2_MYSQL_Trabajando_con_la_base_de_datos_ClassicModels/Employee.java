...
public class Employee{
    ...
    public String getExtesion(){return extesion;}
    public void setExtesion(String extesion){this.extesion = extesion;}
    ...
    public String toString() {
        return "EMPLEADO{CODE: "+employeeNumber+" | APELLIDO: "+lastName+" | NOMBRE: "+firstName+" | EXT: "+extesion+" | EMAIL: "+email+" | O-CODE: "+officeCode+" | RT: "+reportsTo+" | JT: "+jobTitle+"}\n";
    }
}
