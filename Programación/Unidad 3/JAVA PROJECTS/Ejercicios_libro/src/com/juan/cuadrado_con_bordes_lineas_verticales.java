...
public class cuadrado_con_bordes_lineas_verticales {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < a.length; i++) {
            for (int j = 0; j < a[i].length; j++) {
                if(x%2!=0) {
                    if (i == 0 || i == a.length - 1 || j == 0 || j == a[i].length - 1 || j % 2 == 0) {
                        System.out.print(caracter);
                    } else {
                        System.out.print(" ");
                    }
                }else{
                    if (i == 0 || i == a.length - 1 || j == 0 || j == a[i].length - 1 || (j % 2 == 0 && j!=a[i].length-2)) {
                        System.out.print(caracter);
                    } else {
                        System.out.print(" ");
                    }
